#import "JCXNotificationCentre.h"

@implementation JCXNotificationCentre
+ (instancetype)centre {
    return [JCXNotificationCentre new];
}
+ (instancetype)centreWithPostHandler:(NSDictionary * (^)(NSString *))postHandler receivedHandler:(void (^)(NSNotification *))receivedHandler {
    return [[JCXNotificationCentre alloc] initWithPostHandler:postHandler receivedHandler:receivedHandler];
}
